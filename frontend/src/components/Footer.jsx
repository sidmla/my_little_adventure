      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          <div className="lg:col-span-6">
            <div className="overline text-[var(--mla-yellow-bright)]">Let's talk</div>
            <h2 className="h1 text-4xl sm:text-6xl mt-4 max-w-xl">
              Wherever you want to go, <span className="font-serif-editorial italic text-[var(--mla-yellow-bright)]">we'll get you there.</span>
            </h2>
            ...
            <ul className="mt-5 space-y-4">
              <li>
                <a
                  ...
                  className="flex items-center gap-3 hover:text-[var(--mla-yellow-bright)] transition"
        ...
        <div className="mt-16 pt-6 border-t border-white/10 flex flex-col md:flex-row md:items-center justify-between gap-4 text-sm text-[var(--mla-bg)]/55">
          ...
          <div data-testid="viquat-credit" className="flex items-center gap-1.5">
            ...
            <a
              ...
              className="font-semibold text-[var(--mla-yellow-bright)] hover:underline underline-offset-4"
            >
